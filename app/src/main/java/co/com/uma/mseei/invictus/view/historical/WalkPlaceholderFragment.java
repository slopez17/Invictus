 ...
 */
public class WalkPlaceholderFragment extends Fragment {
    ...
    public static WalkPlaceholderFragment newInstance(int index) {
        WalkPlaceholderFragment fragment = new WalkPlaceholderFragment();
